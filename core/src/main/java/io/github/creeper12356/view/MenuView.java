...
Viewable {
    ...
    int menuGap;
    int stringWidth;
    Image[] imgBGChip = new Image[2];
    Image[] imgMenuText = new Image[7];
    Image[] imgMenuTextW = new Image[8];
    Image[] imgMenuTextY = new Image[8];
    Image imgMenuBG;
    Image[] imgMenuChip = new Image[5];
    Image imgSelIcon;
    Image[] imgSelDia = new Image[3];
    Image[] imgRoundChip = new Image[3];
    Image[] imgButton = new Image[4];
    Image[] imgStageMap = new Image[3];
    Animation aniFrame = new Animation();
    Animation aniArrow = new Animation();
    Animation aniStageMap = new Animation();

    MenuView() {
        this.stringWidth = Font.getDefaultFont().stringWidth("\u9152\u919b\u81c2\u78ca\u752b\u514d\u4eff\u8304\u4fc3");
        try {
            this.imgMenuText[2] = Image.createImage((String)"/menutext_2.png");
            this.imgMenuText[3] = Image.createImage((String)"/menutext_3.png");
            this.imgMenuText[4] = Image.createImage((String)"/menutext_4.png");
            this.imgMenuText[5] = Image.createImage((String)"/menutext_5.png");
            this.imgMenuText[6] = Image.createImage((String)"/menutext_6.png");
            for (int i = 0; i < 7; ++i) {
                this.imgMenuTextW[i] = Image.createImage((String)("/menutext_1" + i + ".png"));
                this.imgMenuTextY[i] = Image.createImage((String)("/menutext_2" + i + ".png"));
            }
            this.imgMenuBG = Image.createImage((String)"/bgmenu.png");
            this.imgBGChip[1] = Image.createImage((String)"/bgchip_1.png");
            this.imgMenuChip[0] = Image.createImage((String)"/menuchip_0.png");
            this.imgMenuChip[1] = Image.createImage((String)"/textchip_0.png");
            this.imgMenuChip[2] = Image.createImage((String)"/textchip_1.png");
            this.imgMenuChip[3] = Image.createImage((String)"/textchip_2.png");
            this.imgMenuChip[4] = Image.createImage((String)"/menuchip_1.png");
            this.imgStageMap[0] = Image.createImage((String)"/uichip_5.png");
            this.imgStageMap[1] = Image.createImage((String)"/uichip_14.png");
            this.imgStageMap[2] = Image.createImage((String)"/crown.png");
        }
    ...
    public void drawPause(Graphics graphics) {
        ...
        graphics.drawString("\u662f\u5426\u7ee7\u7eed\u6e38\u620f\uff1f", Resource.halfWidth, Resource.halfHeight, 1 | 2);
    }
    ...
    public void paint(Graphics graphics) {
        switch (this.state) {
            ...
            case 2: {
                ...
                graphics.drawImage(this.imgSelIcon, n - this.imgSelIcon.getWidth() - 2, n3 + 4 + this.currentSel * this.menuGap, 4 | 0x10);
                if (this.process == 1) {
                    Resource.drawPanel(graphics, Resource.halfWidth - 70, Resource.halfHeight - 35, 140, 70);
                    graphics.setColor(0xFFFFFF);
                    graphics.drawString("\u662f\u5426\u5220\u9664\u65e7\u7684\u5b58\u6863", Resource.halfWidth - 65, Resource.halfHeight - 30, 4 | 0x10);
                    graphics.drawString("\u5e76\u5f00\u59cb\u65b0\u6e38\u620f?", Resource.halfWidth - 65, Resource.halfHeight - 10, 4 | 0x10);
                    graphics.drawString(" 1.\u662f  2.\u5426", Resource.halfWidth - 55, Resource.halfHeight + 15, 4 | 0x10);
                } else if (this.process == 2) {
                    Resource.drawPanel(graphics, Resource.halfWidth - 70, Resource.halfHeight - 35, 140, 70);
                    graphics.setColor(0xFFFFFF);
                    graphics.drawString("\u6ca1\u6709\u4efb\u4f55\u5b58\u6863.", Resource.halfWidth - 55, Resource.halfHeight - 30, 4 | 0x10);
                    graphics.drawString("\u662f\u5426\u5f00\u59cb\u65b0\u6e38\u620f?", Resource.halfWidth - 55, Resource.halfHeight - 10, 4 | 0x10);
                    graphics.drawString(" 1.\u662f  2.\u5426", Resource.halfWidth - 55, Resource.halfHeight + 15, 4 | 0x10);
                }
            ...
            case 3: {
                ...
                graphics.drawImage(this.imgSelIcon, n7 - this.imgSelIcon.getWidth() / 2, n6 + this.currentSel * n - this.imgSelIcon.getHeight() / 2, 4 | 0x10);
                graphics.drawImage(this.imgButton[0], 1, Resource.totalHeight - (this.imgButton[0].getHeight() + 1), 4 | 0x10);
                if (this.process == 1) {
            ...
            case 4: {
                ...
                int n12 = 16;
                n = 54;
                graphics.drawImage(this.imgSelDia[1], Resource.halfWidth - n11 + Resource.imgEnemy[0].getWidth() + n12 - this.imgSelDia[1].getWidth() / 2, Resource.halfHeight + n - this.imgSelDia[1].getHeight(), 4 | 0x10);
                graphics.drawImage(Resource.imgEnemy[0], Resource.halfWidth - n11, Resource.halfHeight + n - Resource.imgEnemy[0].getHeight(), 4 | 0x10);
                graphics.drawImage(this.imgSelDia[0], Resource.halfWidth + n11 - Resource.imgPlayer[0].getWidth() - n12 - this.imgSelDia[0].getWidth() / 2 + n10, Resource.halfHeight + n - this.imgSelDia[0].getHeight(), 4 | 0x10);
                graphics.drawImage(Resource.imgPlayer[0], Resource.halfWidth + n11 - Resource.imgPlayer[0].getWidth(), Resource.halfHeight + n - Resource.imgPlayer[0].getHeight(), 4 | 0x10);
                ...
                if (Resource.stageNum < 6) {
                    graphics.drawImage(this.imgRoundChip[1], n10, Resource.halfHeight - 30 - this.imgRoundChip[1].getHeight(), 4 | 0x10);
                    graphics.drawImage(this.imgRoundChip[0], n10 + this.imgRoundChip[1].getWidth() + 3, Resource.halfHeight - 30 - this.imgRoundChip[0].getHeight(), 4 | 0x10);
                } else if (Resource.stageNum == 6) {
                    graphics.drawImage(this.imgRoundChip[0], n10, Resource.halfHeight - 30 - this.imgRoundChip[0].getHeight(), 4 | 0x10);
                    graphics.drawImage(this.imgRoundChip[1], n10 + this.imgRoundChip[0].getWidth() + 3, Resource.halfHeight - 30 - this.imgRoundChip[1].getHeight(), 4 | 0x10);
                }
                if (this.process == 0) {
                    ...
                    graphics.setFont(Resource.sf);
                    graphics.drawString("\u9009\u62e9\u60a8\u6bd4\u8d5b\u7684\u9a6c", 2, Resource.totalHeight - this.imgButton[0].getHeight() - 15, 4 | 0x10);
                    graphics.drawImage(this.imgButton[0], 2, Resource.totalHeight - this.imgButton[0].getHeight(), 4 | 0x10);
                    graphics.drawImage(this.imgButton[1], this.imgButton[0].getWidth() + 10, Resource.totalHeight - this.imgButton[1].getHeight(), 4 | 0x10);
                    n11 = 50;
                    n = 94;
                    n12 = 20;
                    for (int i = 0; i < 6; ++i) {
                        if (i < Resource.stageNum - 1) {
                            graphics.drawImage(this.imgStageMap[0], Resource.halfWidth - n11 + i * n12, Resource.halfHeight + n, 1 | 0x20);
                            continue;
                        }
                        if (i == Resource.stageNum - 1) {
                            if (this.aniStageMap.getFrame() != 0) continue;
                            graphics.drawImage(this.imgStageMap[1], Resource.halfWidth - n11 + i * n12, Resource.halfHeight + n, 1 | 0x20);
                            continue;
                        }
                        graphics.drawImage(this.imgStageMap[1], Resource.halfWidth - n11 + i * n12, Resource.halfHeight + n, 1 | 0x20);
                    }
                    this.aniStageMap.frameProcess();
                    graphics.drawImage(this.imgStageMap[2], Resource.halfWidth - n11 + 5 * n12, Resource.halfHeight + n - this.imgStageMap[1].getHeight() - 1, 1 | 0x20);
                    this.aniArrow.frameProcess();
                    ...
                    if (this.aniFrame.getFrame() < 5) {
                        if (this.aniFrame.getFrame() % 2 == 0) {
                            graphics.drawImage(this.imgRoundChip[2], Resource.halfWidth - this.imgRoundChip[2].getWidth() / 2, Resource.halfHeight - this.imgRoundChip[2].getHeight() + this.imgRoundChip[2].getHeight() / 3, 4 | 0x10);
                        }
                    } else {
            ...
            case 7: {
                ...
                graphics.setColor(106, 90, 24);
                graphics.drawString("\u5f53\u524d\u64cd\u4f5c\u9700\u8981\u8bbf\u95ee", Resource.halfWidth - n, Resource.halfHeight - 55, 20);
                graphics.drawString("\u7f51\u7edc\uff0c\u53ef\u80fd\u4f1a\u4ea7\u751f", Resource.halfWidth - n, Resource.halfHeight - 55 + 15, 20);
                graphics.drawString("\u6570\u636e\u6d41\u91cf.(\u5927\u6982\u610f\u601d)", Resource.halfWidth - n, Resource.halfHeight - 55 + 30, 20);
                graphics.drawString("\u662f\u5426\u7ee7\u7eed?", Resource.halfWidth - n, Resource.halfHeight - 55 + 45, 20);
                graphics.setColor(24, 90, 106);
                graphics.drawString("OK:\u786e\u5b9a  CLR:\u53d6\u6d88", Resource.halfWidth, Resource.halfHeight - 55 + 65, 17);
                break;
            }
            case 8: {
                int n = this.stringWidth / 2;
    ...
    public void keyPressed(int n) {
        if (this.state == 1) {
            if ((this.process == 0 || this.process == 1 || this.process == 2) && n >= 0 && n <= 6) {
                this.currentSel = n;
                n = -5;
            }
            ...
            } else if (this.process == 1 && n == 9) {
                n = 42;
            }
        } else if (this.state == 6 && this.process == 0) {
            if (n == 49) {
                this.currentSel = 0;
                n = -5;
            } else if (n == 50) {
        ...
        switch (n) {
            case 49: {
                if (this.state == 2 && this.process == 1) {
                    Resource.aMainView.setStatus(2, 1);
                    this.clearMM();
                    break;
                }
                if (this.state != 2 || this.process != 2) break;
                Resource.aMainView.setStatus(2, 1);
                this.clearMM();
                break;
            }
            case 50: {
                if (this.state == 2 && this.process == 1 || this.state == 2 && this.process == 2) {
                    this.process = 0;
                    this.currentSel = 1;
                    break;
                }
            ...
            case -1: {
                if (this.state == 3 && this.process == 1 || this.state == 4) break;
            ...
            case -2: 
            case 56: {
                if (this.state == 3 && this.process == 1 || this.state == 4 || this.state == 2 && this.process == 1) break;
                Utils.playSound(5, false);
            ...
            case -3: 
            case 52: {
                if (this.state == 3 && this.process == 0) {
                    if (this.currentSel >= 3 || Resource.players[this.currentSel].type == 3) break;
                    this.selectChangeDia(this.currentSel, 1);
                    this.aniArrow.init(0, 2, 200, false);
                    break;
                }
                if (this.state != 4 || this.process != 0) break;
            ...
            case 48: {
                ...
                if (this.state == 3 && this.process == 1) {
                    this.process = 0;
                    break;
                }
                if (this.state == 6 && this.process == 1) {
                    this.process = 0;
                    break;
                }
                Resource.aMainView.setStatus(0, 1);
    ...
    public void init() {
        ...
        switch (this.state) {
            case 1: {
                ...
                System.gc();
                if (Resource.aMainView.aBoardView != null) break;
            ...
            case 3: {
                ...
                Resource.players[0].type = 1;
                Resource.players[0].diaType = 0;
                this.imgSelDia[0] = Resource.imgDiaAvt[Resource.players[0].diaType];
                Resource.players[1].type = 2;
                Resource.players[1].diaType = 1;
                this.imgSelDia[1] = Resource.imgDiaAvt[Resource.players[1].diaType];
                Resource.players[2].type = 3;
                Resource.players[2].diaType = -1;
                this.imgSelDia[2] = null;
                Resource.players[0].aiLevel = 6;
                Resource.players[1].aiLevel = 3 + Resource.getRand(1);
                Resource.players[2].aiLevel = 5 + Resource.getRand(1);
            ...
            case 4: {
                ...
                Resource.players[0].type = 1;
                Resource.players[1].type = 2;
                Resource.players[0].charID = 0;
                Resource.players[1].charID = Resource.stageNum;
                Resource.players[0].diaType = 0;
                Resource.players[1].diaType = Resource.getRand(24) + 1;
                Resource.players[0].aiLevel = 6;
                Resource.players[1].aiLevel = Resource.stageNum;
                this.imgSelDia[0] = Resource.imgDiaAvt[Resource.players[0].diaType];
                this.imgSelDia[1] = Resource.imgDiaAvt[Resource.players[1].diaType];
                try {
                    Resource.imgPlayer[0] = Image.createImage((String)"/char_0_n.png");
                    Resource.imgPlayer[1] = Image.createImage((String)"/char_0_good.png");
                    Resource.imgPlayer[2] = Image.createImage((String)"/char_0_bad.png");
                    Resource.imgEnemy[0] = Image.createImage((String)("/char_" + Resource.stageNum + "_n.png"));
                    Resource.imgEnemy[1] = Image.createImage((String)("/char_" + Resource.stageNum + "_good.png"));
                    Resource.imgEnemy[2] = Image.createImage((String)("/char_" + Resource.stageNum + "_bad.png"));
                    if (Resource.stageNum < 6) {
                        this.imgRoundChip[0] = Image.createImage((String)("/roundnum_" + Resource.stageNum + ".png"));
                    } else if (Resource.stageNum == 6) {
                        this.imgRoundChip[0] = Image.createImage((String)"/roundchip_0.png");
                    }
                    this.imgRoundChip[1] = Image.createImage((String)"/roundchip_3.png");
                    this.imgRoundChip[2] = Image.createImage((String)"/roundchip_1.png");
                    this.imgButton[0] = Image.createImage((String)"/button_move.png");
                    this.imgButton[1] = Image.createImage((String)"/button_ok.png");
                }
                catch (IOException iOException) {
                    // empty catch block
                }
            ...
            case 5: {
                this.newDia = 0;
                for (int i = 5; i < 25; ++i) {
                    if (i == 11 || i == 21 || Resource.enableDiaList[i] != 0) continue;
                ...
                this.process = 0;
                if (Resource.bOpenSpecialGame) break;
        ...
        switch (this.state) {
            ...
            case 3: {
                ...
                if (n == 0 || n == 1 || n == 2) {
                    ...
                    if (Resource.players[n].getType() != 3) break;
                    Resource.players[n].type = 1;
                    Resource.players[n].diaType = Resource.players[n].diaType >= 0 ? --Resource.players[n].diaType : 0;
                    this.selectChangeDia(n, 2);
                    break;
            ...
            case 6: {
                ...
                if (n != 1 || !Resource.bOpenSpecialGame) break;
                Resource.aMainView.aBoardView = null;
                System.gc();
                Resource.aMainView.setStatus(9, 0);
                if (Resource.imgDiaAvt[0] != null) break;
                for (int i = 0; i < 25; ++i) {
                    Resource.imgDiaAvt[i] = Resource.loadImage("/dia_avt_" + i + ".png");
                }
                break;
    ...
    boolean selectChangeDia(int n, int n2) {
        ...
        if (n2 == 1) {
            if (Resource.players[n].diaType == 0) {
                for (n3 = 24; n3 >= 0; --n3) {
                    if (Resource.enableDiaList[n3] == 0) continue;
        ...
        for (n3 = 0; n3 < 3; ++n3) {
            if (n3 == n || Resource.players[n3].getType() == 3 || Resource.players[n].diaType != Resource.players[n3].diaType) continue;
            bl = false;
        }
    ...
    void drawVSHelp(Graphics graphics) {
        ...
        graphics.drawString("\u4e0a\u4e0b\u79fb\u52a8", Resource.halfWidth - n4, Resource.halfHeight - n3 + n * 1, 4 | 0x10);
        graphics.drawString("\u73a9\u5bb6\u5c5e\u6027", Resource.halfWidth - n4, Resource.halfHeight - n3 + n * 2, 4 | 0x10);
    }
    ...
    void drawSpecialMenu(Graphics graphics) {
        ...
        graphics.drawImage(this.imgSelIcon, n10 - this.imgSelIcon.getWidth() - 2, n11 + this.currentSel * this.menuGap, 4 | 0x10);
    ...
    void drawDiaListWVGA(Graphics graphics) {
        ...
        int n6 = 52;
        int n7 = 34;
        Resource.drawPanel(graphics, Resource.halfWidth - 160, Resource.halfHeight - 109, Resource.totalWidth, Resource.totalHeight);
        for (int i = 0; i < 25; ++i) {
            if (Resource.enableDiaList[i] != 0) {
