...
public class Resource {
    ...
    static void drawTalkBalloon(Graphics graphics, int n, int n2, int n3, int n4, int n5, int n6) {
        int n7 = 0;
    ...
    static void drawTalkButton(Graphics graphics, int n, int n2) {
        ...
        graphics.drawImage(imgBallonChip[3 + n3], n, n2 - imgBallonChip[3 + n3].getHeight(), 4 | 0x10);
    ...
    static void drawPanel(Graphics graphics, int n, int n2, int n3, int n4) {
        ...
        graphics.drawImage(imgPanelEdge[1], n + n3 - imgPanelEdge[1].getWidth(), n2, 4 | 0x10);
        graphics.drawImage(imgPanelEdge[2], n, n2 + n4 - imgPanelEdge[2].getHeight(), 4 | 0x10);
        graphics.drawImage(imgPanelEdge[3], n + n3 - imgPanelEdge[3].getWidth(), n2 + n4 - imgPanelEdge[3].getHeight(),
                4 | 0x10);
    }
    ...
    static void drawInCastle(Graphics graphics) {
        ...
        for (n3 = n7; n3 < totalWidth; n3 += image.getWidth()) {
            graphics.drawImage(image, n3, n4, 4 | 0x10);
            graphics.drawImage(image, halfWidth - (n3 - halfWidth) - image.getWidth(), n4, 4 | 0x10);
        }
        n6 = image.getHeight();
        image = Resource.loadImage("/bgchip_9.png");
        graphics.drawImage(image, halfWidth - image.getWidth() / 2, n4 + n6 / 2, 4 | 0x10);
        n4 += n6;
        ...
        graphics.drawImage(image, halfWidth - n8, halfHeight + n2 - image.getHeight(), 4 | 0x10);
        graphics.drawImage(image, halfWidth - n8, halfHeight + n2 - image.getHeight() + 31, 4 | 0x10);
        graphics.drawImage(image, halfWidth - n8, halfHeight + n2 - image.getHeight() + 62, 4 | 0x10);
        graphics.drawImage(image, halfWidth + n8 - image.getWidth(), halfHeight + n2 - image.getHeight(), 4 | 0x10);
        graphics.drawImage(image, halfWidth + n8 - image.getWidth(), halfHeight + n2 - image.getHeight() + 31,
                4 | 0x10);
        graphics.drawImage(image, halfWidth + n8 - image.getWidth(), halfHeight + n2 - image.getHeight() + 62,
                4 | 0x10);
        image = null;
    }
    ...
    static void drawNum(Graphics graphics, int n, int n2, int n3, int n4, Image[] imageArray) {
        block11: {
            int n5;
            int n6;
            int n7;
    ...
    public static String[] getNewStrArr(String string, int n) {
        ...
        StringBuffer[] stringBufferArray = new StringBuffer[sf.stringWidth(string.toString()) / n + 5];
        int n3 = 0;
    ...
    static {
        ...
        homes = new byte[] { 9, 12, 8, 11, 10, 11, 7, 10, 9, 10, 11, 10, 6, 9, 8, 9, 10, 9, 12, 9, 0, 9, 1, 8, 2, 9, 2,
                7, 3, 8, 4, 9, 3, 6, 4, 7, 5, 8, 6, 9, 0, 3, 2, 3, 1, 4, 4, 3, 3, 4, 2, 5, 6, 3, 5, 4, 4, 5, 3, 6, 9, 0,
                10, 1, 8, 1, 11, 2, 9, 2, 7, 2, 12, 3, 10, 3, 8, 3, 6, 3, 18, 3, 17, 4, 16, 3, 16, 5, 15, 4, 14, 3, 15,
                6, 14, 5, 13, 4, 12, 3, 18, 9, 16, 9, 17, 8, 14, 9, 15, 8, 16, 7, 12, 9, 13, 8, 14, 7, 15, 6 };
